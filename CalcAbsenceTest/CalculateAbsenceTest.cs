...
namespace CalcAbsenceTest {
  public class CalculateAbsenceTest {
    ...
    public void FindAbsenceList() {
      ...
      Student studentTest1 = new Student { StudentId = 1, Name = "Carlos", Semester = 3 };
      Student studentTest2 = new Student { StudentId = 2, Name = "Hector", Semester = 3 };
      Student studentTest3 = new Student { StudentId = 3, Name = "Gustavo", Semester = 3 };
      Student studentTest4 = new Student { StudentId = 4, Name = "Juan", Semester = 3 };
